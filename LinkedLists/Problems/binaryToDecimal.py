...
This method does not have length object and we are not allowed to iterate first to find the length.

In this context, a binary number is a sequence of 0s and 1s. 
The LinkedList class represents this binary number such that each node in the linked list contains a single digit (0 or 1) 
